...
function render(questionIndex) {
  ...
  ulCreate.innerHTML = "";
  // For loops to loop through all info in array and will only append question title only
...
// All done will append page to show user score and input initals
function allDone() {
  questionsDiv.innerHTML = "";
  ...
  // Event listener to capture initials and local storage for initials and score, also travels to final page
